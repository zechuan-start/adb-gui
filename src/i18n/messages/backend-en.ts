...
export const backendErrorsEn = {
  ...
  "files.metadataNotUtf8": () => "The device file metadata is not UTF-8",
  "files.invalidBatchMetadata": () => "Invalid device folder batch metadata",
  "files.missingBatchPath": () => "A device folder batch is missing a path",
  "files.invalidMode": () => "Invalid device file mode",
