...
pub const FILES_METADATA_NOT_UTF8: &str = "files.metadataNotUtf8";
pub const FILES_INVALID_BATCH_METADATA: &str = "files.invalidBatchMetadata";
pub const FILES_MISSING_BATCH_PATH: &str = "files.missingBatchPath";
pub const FILES_INVALID_MODE: &str = "files.invalidMode";
...
#[cfg(test)]
pub const ALL: &[&str] = &[
    FILES_METADATA_NOT_UTF8,
    FILES_INVALID_BATCH_METADATA,
    FILES_MISSING_BATCH_PATH,
    FILES_INVALID_MODE,
    FILES_PATH_NOT_UTF8,
    ADB_COMMAND_FAILED,
    #[cfg(windows)]
